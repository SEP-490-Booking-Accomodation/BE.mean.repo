...
const { authMiddleware, isCustomer, isCusAndOwner } = require("../middlewares/authMiddleware");
const {
 ...
 */
router.post("/create-payment-information", authMiddleware, isCusAndOwner, createPaymentInformation);
